...
export default function ProfilePage() {
    ...
    return (
        <>
            <div className="space-y-6 w-[90%] mx-auto mt-20">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <button
                        ...
                        className="bg-gradient-to-br from-[#4648d4] to-[#2170e4] text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:shadow-[0_0_25px_rgba(201,123,54,0.25)] transition-all flex items-center gap-2"
                    >
                        Edit Profile
                    </button>
                </div>
